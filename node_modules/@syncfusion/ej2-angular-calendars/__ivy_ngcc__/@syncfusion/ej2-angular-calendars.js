...
CalendarModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
/**
 * @nocollapse
 */
...
CalendarAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [
        IslamicService
...
DatePickerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
/**
 * @nocollapse
 */
...
DatePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[CommonModule, DatePickerModule], DatePickerModule] });
/**
 * @nocollapse
 */
...
TimePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[CommonModule, TimePickerModule], TimePickerModule] });
/**
 * @nocollapse
 */
...
PresetsDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: PresetsDirective, selectors: [["e-presets"]], contentQueries: function PresetsDirective_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, PresetDirective, 0);
    } if (rf & 2) {
        let _t;
...
DateRangePickerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DateRangePickerComponent, selectors: [["ejs-daterangepicker"]], contentQueries: function DateRangePickerComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵcontentQuery(dirIndex, PresetsDirective, 1);
    } if (rf & 2) {
        let _t;
...
DateRangePickerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
/**
 * @nocollapse
 */
...
DateRangePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[CommonModule, DateRangePickerModule], DateRangePickerModule] });
/**
 * @nocollapse
 */
...
DateTimePickerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
/**
 * @nocollapse
 */
...
DateTimePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[CommonModule, DateTimePickerModule], DateTimePickerModule] });
/**
 * @nocollapse
 */
